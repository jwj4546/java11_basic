...
public class ScheduleExam {
	public static void main(String[] args) throws IOException {
		...
		if(ch == 'R' || ch =='r') {
			...
			System.out.println("지원하지 않는 스케줄링 입니다.");
		}
		
		//switch-case문
		/*
		 * switch(ch) { case 'R' : case 'r' : s = new RoundRobin(); break; case 'P' :
		 * case 'p' : s = new PriorityAllocation(); break; case 'L' : case 'l' : s = new
		 * LeastJob(); break; default: System.out.println("지원하지 않는 스케줄링입니다."); }
		 */
