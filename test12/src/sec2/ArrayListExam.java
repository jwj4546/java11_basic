...
public class ArrayListExam {
	public static void main(String[] args) {
		...
		for(int i=1;i<10;i++) {
			Member mem = new Member(i, "cho"+i, 30+i, 0);
			memList.add(mem);
		}
		Member mem2 = new Member(11, "choi", 40, 0);
		memList.add(mem2);
		...
		Member tmp1 = new Member(11, "choi", 40, 0);
		System.out.println(tmp1.getMage()+"의 존재유무 : "+memList.contains(tmp1));
		...
		//자주 사용하는 메소드 : add, remove, contains, isEmpty, size, clear, get
	}
